        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              ...
              <i class="menu-icon tf-icons bx bx-dock-top"></i>
              <div data-i18n="Account Settings">Add SubCategory</div>
              </a>
            </li>        
            <li class="menu-item">
              <a href=" {{route('allsubcategory')}}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-dock-top"></i>
              <div data-i18n="Account Settings">All SubCategory</div>
              </a>
            </li> 
            <li class="menu-header small text-uppercase">
            ...
            <li class="menu-item">
              ...
              <i class="menu-icon tf-icons bx bx-dock-top"></i>
              <div data-i18n="Account Settings">Complete Order</div>
              </a>
            </li> 
            ...
            <li class="menu-item">
              ...
              <i class="menu-icon tf-icons bx bx-dock-top"></i>
              <div data-i18n="Account Settings">Canceled Order</div>
              </a>
            </li> 
